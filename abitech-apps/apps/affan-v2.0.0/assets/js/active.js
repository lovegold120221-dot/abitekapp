...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (settingCard) {
        settingCard.addEventListener('click', function (e) {
            e.stopPropagation();
        });
    }
    ...
    /* ================================
      :: 2.1.0 => Dropdown Menu
      (This code is dependent on [slideToggle.min.js] plugin)
    ================================ */
    ...
    if (dropdownTargetLen > 0) {
        ...
        for (let i = 0; i < navUrlLen; i++) {
            navUrl[i].insertAdjacentHTML('beforeend', '<span class="dropdown-icon"><i class="ti ti-chevron-down"></i></span>');
        ...
        sidenavNav.addEventListener('click', function (e) {
            if (e.target.classList.contains('nav-url')) {
                ...
                slideToggle(nextTarget, 200);
            }
        });
    }

    /* ================================
      :: 2.2.1 => Tiny Slider One
      (This code is dependent on [tiny-slider.js] plugin)
    ================================ */
    ...
    if (document.querySelectorAll('.tiny-slider-one-wrapper').length > 0) {
        tns({
            ...
            speed: 1000,
            mouseDrag: true,
            controlsText: [('<i class="ti ti-chevron-left"></i>'), ('<i class="ti ti-chevron-right"></i>')]
        });
    }

    /* ================================
      :: 2.2.2 => Tiny Slider Two
      (This code is dependent on [tiny-slider.js] plugin)
    ================================ */
    ...
    /* ================================
      :: 2.2.6 => Testimonial Slides Three
      (This code is dependent on [tiny-slider.js] plugin)
    ================================ */
    ...
    /* ================================
      :: 2.3 Isotope
      (This code depends on {Imagesloaded & Isotope} plugins)
    ================================ */
    ...
    /* ================================
      :: 2.4 => Image Gallery
      (This code is dependent on [venobox.min.js] plugin)
    ================================ */
    ...
    /* ================================
      :: 2.5 => Counter Up
      (This code is dependent on [index.js] plugin)
    ================================ */
    ...
    /* ================================
      :: 2.6.1 => ion Range Slider One
      (This code is dependent on [rangeslider.min.js] plugin)
    ================================ */
    ...
    /* ================================
      :: 2.7 => Data Table
      (This code is dependent on [vanilla-dataTables.min.js] plugin)
    ================================ */
    ...
    if (dataTable1) {
        new DataTable(dataTable1, {
            ...
            sortable: true,
            fixedHeight: false,
            prevText: '<i class="ti ti-arrow-narrow-left"></i>',
            nextText: '<i class="ti ti-arrow-right-short"></i>',
            labels: {
                placeholder: 'Search',
                perPage: '{select}',
                noRows: 'No data!',
    ...
    /* ================================
      :: 2.8 => Password Meter
      (This code is dependent on [pswmeter.js] plugin)
    ================================ */
    ...
    /* ================================
      :: 2.9 => Nice Select
      (This code is dependent on [nice-select2.js] plugin)
    ================================ */

    const selects = document.querySelectorAll('.affan-nice-select');
    ...
    /* ================================
      :: Toast Animation
      This function creates the line animation effect on a toast
    ================================ */
    ...
    /* ================================
      :: Offline/Online Detection Demo Button Code
      (Please remove this code, when your website is ready to go live.)
    ================================ */
